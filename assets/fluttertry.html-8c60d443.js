import{_ as s,W as l,X as d,Y as a,Z as e,$ as t,a0 as n,a1 as r,C as o}from"./framework-a4c02b8f.js";const u={},c=e("h1",{id:"flutter在windows桌面软件开发",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#flutter在windows桌面软件开发","aria-hidden":"true"},"#"),t(" Flutter在windows桌面软件开发")],-1),v=e("figure",null,[e("img",{src:"https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202307291114364.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),h=e("hr",null,null,-1),m=e("p",null,"最近打算试一试桌面软件的开发，听说过QT，苦于没有C++基础，并且go的GUI生态太拉跨了。后来在网上了解到Flutter，现在已经可以稳定开发windows桌面软件了，结合Dart进行开发，而且性能相当的可以，于是本文记录一下flutter的尝试。",-1),p={href:"https://flutter.cn/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://flutter.cn/docs",target:"_blank",rel:"noopener noreferrer"},b={href:"https://flutter.cn/docs/get-started/install",target:"_blank",rel:"noopener noreferrer"},f=r('<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>第一件事是下载flutter，由于是谷歌开源的，部分网页需要魔法上网。</p><figure><img src="https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202307291155426.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>下载下来后就是一个压缩包，Flutter SDK是包含了完整的Dart SDK，解压到自己想要的位置后将bin目录添加到系统变量中。</p><h2 id="换源" tabindex="-1"><a class="header-anchor" href="#换源" aria-hidden="true">#</a> 换源</h2><p>安装完成后，需要配置一下镜像源，因为flutter服务需要下载一些东西，默认配置的话国内网络多半是下载不了的。</p>',6),_={href:"https://mirrors.tuna.tsinghua.edu.cn/help/flutter/",target:"_blank",rel:"noopener noreferrer"},w=r(`<p>可以使用清华镜像源，将以下几个替换掉</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// flutter sdk镜像
