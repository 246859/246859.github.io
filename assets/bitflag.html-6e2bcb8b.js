import{_ as s,W as a,X as e,Y as p,Z as n,$ as o,a1 as t}from"./framework-a4c02b8f.js";const l={},c=n("h1",{id:"位运算保存状态",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#位运算保存状态","aria-hidden":"true"},"#"),o(" 位运算保存状态")],-1),i=n("figure",null,[n("img",{src:"https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202311291911647.png",alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1),r=t(`<hr><h2 id="理论" tabindex="-1"><a class="header-anchor" href="#理论" aria-hidden="true">#</a> 理论</h2><p>在go里面，没有提供枚举这一类型，所以我们会通过声明常量来表示一些特定的状态，比如下面这种形式</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">const</span> <span class="token punctuation">(</span>
