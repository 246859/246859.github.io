...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过双循环执行目标<code>build</code>，这样一来就可以将所有预定平台的二进制文件全部自动编译出来。</p>`,82);function b(g,h){const e=c("ExternalLinkIcon");return l(),t("div",null,[u,r,p(" more "),v,n("p",null,[a("本文这里只是简单介绍下makefile中的语法，如果你想进行细致的学习的可以前往"),n("a",k,[a("Document | GNU make"),o(e)]),a("进行了解。")]),m])}const $=i(d,[["render",b],["__file","makefile.html.vue"]]);export{$ as default};
