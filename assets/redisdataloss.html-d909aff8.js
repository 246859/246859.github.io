...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>复制master数据后，我们的数据就没了，然后备份过后redis数据也没了。多半是redis密码太简单导致的问题，于是修改密码后再看后续的情况。</p>`,9);function c(v,o){return s(),i("div",null,[l,u,d(" more "),t])}const b=n(r,[["render",c],["__file","redisdataloss.html.vue"]]);export{b as default};
