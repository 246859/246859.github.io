...
<span class="token operator">|</span>/
* 0224b74 <span class="token punctuation">(</span>test, <span class="token function">op</span><span class="token punctuation">)</span> initial commit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样一来，所有分支的提交都变成线性的了，就如下图所示。这个例子演示了如何在变基时，选择性的合并修改，即便是四个分支，五分支也是同样如此。</p><figure><img src="https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202309091608582.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="缺点" tabindex="-1"><a class="header-anchor" href="#缺点" aria-hidden="true">#</a> 缺点</h3>`,133),d={href:"https://git-scm.com/book/zh/v2/Git-%E5%88%86%E6%94%AF-%E5%8F%98%E5%9F%BA#_merge_rebase_work",target:"_blank",rel:"noopener noreferrer"},r=s(`<p>图中分为远程仓库和本地仓库，你的本地仓库在远程仓库的基础之上做了一些修改。</p><figure><img src="https://git-scm.com/book/en/v2/images/perils-of-rebasing-1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>然后另外一个人做了一些合并修改，并推送到远程仓库，随后你又拉取了这些修改到你的本地仓库，并将修改合并到你本地的分支，此时提交历史是这样的。</p><figure><img src="https://git-scm.com/book/en/v2/images/perils-of-rebasing-2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>结果那个人吃饱了撑的又把合并操作撤销了，改用变基操作，然后又用<code>git push --force</code>覆盖了远程仓库上的提交历史。这时如果你再次拉取远程仓库上的修改，你就会发现本地仓库中多出来一些提交，这些多出来的提交，就是变基操作在目标分支上复原的提交。此时的提交历史如下图所示</p><figure><img src="https://git-scm.com/book/en/v2/images/perils-of-rebasing-3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>可以看到c6是原来远程仓库中三方合并c1，c4，c5产生的新提交，但是那个人将合并撤销后改用变基，这就意味着c6提交在远程仓库中被废弃了，不过在你的本地仓库并没有废弃，而且你本地仓库的c7提交是从c6提交合并而来的，c4&#39;是变基操作将c4重新在目标分支上应用而产生的新提交。再次将远程分支合并过后，其实c6与c4&#39;这两个提交内容是完全一样的，等于是你将相同的内容又合并了一次。本地仓库的提交历史就像下图一样</p><figure><img src="https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202309091658757.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>c8是由合并而产生的新提交，你的本地仓库中会同时存在c4与c4&#39;这两个提交，它们两个理应不应该同时出现，这时查看提交历史，你会发现c4与c4&#39;的提交信息完全一模一样。更大的问题是，假如你想要把你的修改提交到远程仓库上，等于就是你把别人通过变基操作丢弃掉的提交（c4，c6）又找了回来。</p><p>面对这种问题，你应该将远程分支作为目标分支进行变基，就是执行如下命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> rebase rebase teamone/master
