...
退出 DiskPart...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时重新打开磁盘管理工具就会显示恢复分区了。</p><p>重新创建后的恢复分区会在资源管理中可见，如果想临时隐藏可以通过如下命令来临时删掉盘符</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>DISKPART&gt; remove
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>倘若要永久隐藏的话可以修改其属性即可</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>DISKPART&gt; gpt attributes=0xC000000000000001
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,43);function x(h,w){const d=r("ExternalLinkIcon");return s(),l("div",null,[o,u,t(" more "),m,e("p",null,[i("我们需要下载win10的ISO镜像，并从中获取"),g,i("文件，然后复制到电脑的对应位置，这里推荐用系统库下载"),e("a",b,[i("MSDN系统库－致力于原版windows生态服务 (xitongku.com)"),c(d)]),i("，微软目前不再提供ISO镜像下载了。")]),p])}const R=a(v,[["render",x],["__file","win10_reset.html.vue"]]);export{R as default};
