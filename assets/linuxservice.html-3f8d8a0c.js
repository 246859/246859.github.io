import{_ as i,W as n,X as l,Y as s,Z as e,$ as d,a1 as a}from"./framework-a4c02b8f.js";const c={},r=e("h1",{id:"ubuntu自定义系统服务",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#ubuntu自定义系统服务","aria-hidden":"true"},"#"),d(" ubuntu自定义系统服务")],-1),t=e("figure",null,[e("img",{src:"https://w.wallhaven.cc/full/kx/wallhaven-kx36mq.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),o=a(`<hr><p>在开发项目时，对于一些后台应用，可以自定义成linux的service，这样能够更加方便的管理。</p><p>首先在<code>/etc/systemd/system</code>下，创建一个<code>xxx.service</code>的文件，<code>xxx</code>是服务名。</p><p>service文件有特殊的配置格式，下面是一个简单的例子</p><div class="language-txt line-numbers-mode" data-ext="txt"><pre class="language-txt"><code>[Unit]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>随后使用<code>service hello service </code> 即可开启</p>`,14);function v(u,m){return n(),l("div",null,[r,t,s(" more "),o])}const b=i(c,[["render",v],["__file","linuxservice.html.vue"]]);export{b as default};
